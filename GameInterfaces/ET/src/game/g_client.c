...
void ClientUserinfoChanged( int clientNum ) {
	...
	// cs: uncomment the next two lines to see the crash when adding a bot
	// this is basically what it happening with etpub since 
	// for some reason guid spoofing isn't being bypassed with an SVF_BOT 
	// check. that's a different can of worms though i guess. 
	/*if ( clientNum == 1 )
		trap_DropClient(1, "test", 0);*/
}
